...
def get_tweets(keyword):
    """
    Fetches a JSON object with the recent tweets that contain your search keyword.
    """
...
def make_page(keyword, html):
    """
    Takes the HTML generated by format_tweets() and puts it into a basic HTML page.
    """
    output = []
    addline = output.append
